...
#This is where the data we want to analize is declared. If we wanted to pass in a variable or list of stars we could definitely do that.
star = 10464078
#currently this just asks for all of the data on a star but some stars don't always have data for all quarters. We should figure out how to query the dataset to only ask for the associated data sets.     
for i in range(17):
